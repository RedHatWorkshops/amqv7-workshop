...
public class QpidSender {  public static void main(String args[]) throws Exception{

      try {
         Hashtable<String, Object> properties = new Hashtable<>();
         properties.put("java.naming.factory.initial", "org.apache.qpid.jms.jndi.JmsInitialContextFactory");
         properties.put("connectionFactory.ConnectionFactory", "failover:(amqp://localhost:61616)");
